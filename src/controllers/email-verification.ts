...
import { querySaveEmailVerify, queryUserProfile } from "../services/user-query-3";
import otpGenerator from "../modules/otp-generator";
import sendEmail from "../modules/email/emailers/email-sender";
...
const getCheckEmailVerify = async (req: Request, res: Response) => {
    try {
        ...
        console.log('error in check if email verified');
