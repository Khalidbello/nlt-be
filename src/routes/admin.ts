...
import { admiGetLessonContent, adminEditLecure, adminGetLessonData, createNewLecture, handleCourseDelete, requestCourseDelOtp } from "../controllers/admin/courses-3";
